...
var BdAIMarker = function BdAIMarker(layer, draft, resizeAnnotation) {
  ...
  _classPrivateFieldInitSpec(this, _mouseEventHandler, {
    ...
    value: function value(e, clientX, clientY) {
      // e.preventDefault();
      // e.stopPropagation();
      var readOnlyAccept = !_this.options.editable && !_this.options.readOnlyCanSelected;
      var readOnlyButAccept = !_this.options.editable && _this.options.readOnlyCanSelected;
      ...
      if (readOnlyButAccept && !_this.options.readOnlyAcceptEvent.includes(eventType)) {
        return;
      }
