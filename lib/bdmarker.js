...
var drawCursorEvent = _config.MOUSE_EVENT;
...
var BdAIMarker = function BdAIMarker(layer, draft, resizeAnnotation) {
  ...
  this.mouseEventHandler = function (e, clientX, clientY) {
    var boundRect = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _this.boundRect();
    ...
    if (eventType === _config.MOUSE_EVENT[0]) {
      if (e.target.classList.contains('annotation') || e.target.classList.contains('' + _config.PREFIX_RESIZE_DOT)) {
  ...
  this.clearAll = function () {
    var annotations = _this.layer.querySelectorAll('div.annotation');
