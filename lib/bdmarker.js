...
var _eventTargetOnTransform = new WeakMap();

var _moveX = new WeakMap();

var _moveY = new WeakMap();

var _anchorX = new WeakMap();

var _anchorY = new WeakMap();

var _actionDown = new WeakMap();

var _resizeAnnotation = new WeakMap();

var _draftAnnoData = new WeakMap();

var _callback_handler = new WeakMap();

var _compatibalBoundRect = new WeakMap();

var _mouseEventHandler = new WeakMap();

var _anchorAt = new WeakMap();

var _filterOutOfBounds = new WeakMap();

var _dragTo = new WeakMap();
...
var BdAIMarker = function BdAIMarker(layer, draft, resizeAnnotation) {
  ...
  _eventTargetOnTransform.set(this, {
    writable: true,
    value: false
  });
  ...
  _actionDown.set(this, {
    writable: true,
    value: void 0
  });

  _resizeAnnotation.set(this, {
    writable: true,
    value: void 0
  });

  _draftAnnoData.set(this, {
    writable: true,
    value: void 0
  });

  _callback_handler.set(this, {
    writable: true,
