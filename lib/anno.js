...
var _boundRect = new WeakMap();

var _callback_handler = new WeakMap();

var _lastX = new WeakMap();

var _lastY = new WeakMap();

var _moveX = new WeakMap();

var _moveY = new WeakMap();

var _currentMovementDisabled = new WeakMap();

var _event = new WeakMap();

var _uiconstruct = new WeakMap();

var _removeAnnotationEvent = new WeakMap();

var _targetEventType = new WeakMap();
...
var ResizeAnnotation = function ResizeAnnotation(parentNode, boundRect) {
  ...
  _currentMovementDisabled.set(this, {
    writable: true,
    value: void 0
  });
  ...
  _defineProperty(this, "getCurrentAnnotationData", function () {//  todo
  });
  ...
  _removeAnnotationEvent.set(this, {
    writable: true,
